...
export default function Contact() {
  return (
    <div className="container" style={{ padding: '2.5rem 1rem 1rem 1rem' }}>
      <ScrollReveal animation="fade-down" duration={1000}>
        <h1 className="section-title" style={{ color: '#000', marginBottom: '1rem' }}>Contact Us</h1>
      </ScrollReveal>
      ...
      <div className="contact-wrapper">
        ...
        <div className="responsive-grid">
          ...
          {/* Contact Info */}
          <ScrollReveal animation="fade-right" delay={100} style={{ width: '100%', height: '100%' }}>
            <div className="card contact-card" style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          {/* Contact Form */}
          <ScrollReveal animation="fade-left" delay={250} style={{ width: '100%', height: '100%' }}>
            <div className="card contact-card" style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
